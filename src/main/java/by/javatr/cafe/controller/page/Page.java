...
public interface Page {
    ...
    default void displayDishes(HttpServletRequest req, HttpServletResponse resp, IDishService dishService, IUserService userService, int category_id , String PATH, Logger logger) throws ServletException, IOException {
        try {
            ...
            for (Dish dish :dishes) {
                if(dish.getCategoryId() == category_id){
                    drinks.add(dish);
                }
            }
