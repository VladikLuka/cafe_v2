...
public class DbColumns {
    ...
    public static final String ADDRESS_IS_AVAILABLE = "address_isAvailable";
    ...
    public static final String ORDER_CREDIT_TIME = "order_credit_time";
    ...
    public static final String USER_IS_CREDIT = "user_isCredit";
